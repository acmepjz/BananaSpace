...
(function (mod) {
    ...
    var environments = ["align","align*","alignat","alignat*","aligned","alignedat","array","Bmatrix","bmatrix","cases","corollary","definition","enumerate","eqnarray","eqnarray*","equation","equation*","gather","gather*","gathered","itemize","lemma","matrix","multline","multline*","pmatrix","proof","proposition","remark","smallmatrix","split","subarray","theorem","Vmatrix","vmatrix","xy"];
